...
#ifndef QLEVER_SRC_UTIL_WINDOWS_THREADAGNOSTICSHAREDMUTEX_H
#define QLEVER_SRC_UTIL_WINDOWS_THREADAGNOSTICSHAREDMUTEX_H
...
// it lives in `util/windows/` because only the Windows build needs it.
...
#endif  // QLEVER_SRC_UTIL_WINDOWS_THREADAGNOSTICSHAREDMUTEX_H
